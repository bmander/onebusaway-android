...
/** The sheet is shown (peeking or full) iff a stop is focused on the NEARBY tab. */
internal fun shouldShowSheet(focusedStop: FocusedStop?, selectedItem: HomeNavItem): Boolean =
    focusedStop != null && selectedItem == HomeNavItem.NEARBY
