 ...
 * The instance is sourced from [DatabaseProvider] so it's the same singleton the few remaining
 * non-Hilt callers (AlertsRepository, SurveyRepository) use. Per-table consumer DAOs are added here as
 * the stores/repositories are flipped to Room.
 */
@Module
