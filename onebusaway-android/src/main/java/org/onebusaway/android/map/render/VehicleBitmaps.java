 ...
 * old {@code VehicleOverlay}, lifted out of the (Google-only) {@code VehicleIconFactory}.
 */
public final class VehicleBitmaps {
    ...
    /** Returns the tinted vehicle bitmap for the given status (the legacy getVehicleIcon body). */
    public static Bitmap vehicleBitmap(Context context, boolean isRealtime, ObaTripStatus status,
        ...
        return getBitmap(context, vehicleType, colorResource, halfWind);
    }
