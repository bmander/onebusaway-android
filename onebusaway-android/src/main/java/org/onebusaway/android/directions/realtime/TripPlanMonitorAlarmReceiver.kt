 ...
 * foreground [TripPlanMonitorService]. Replaces the deprecated `RealtimeWakefulReceiver` — no wake
 * lock is held because the foreground service keeps the CPU awake for its (short, bounded) run.
 *
