...
/**
 * MapLibre thin {@link androidx.fragment.app.Fragment} wrapper: supplies a {@link MapLibreMapHost}
 ...
 */
public class MapLibreMapFragment extends AbstractObaMapHostFragment {
    ...
    protected ObaMapHost createHost(Activity activity, MapHostDeps deps, Bundle args) {
        return new MapLibreMapHost(activity, deps, args);
    }
}
