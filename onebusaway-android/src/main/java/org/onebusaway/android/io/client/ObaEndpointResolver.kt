 ...
 * [PreferencesRepository]) rather than the legacy mutable `ObaApi.getDefaultContext()` god-object.
 * This is the single source of truth for "which host + key + app identifiers does a request get".
 */
@Singleton
