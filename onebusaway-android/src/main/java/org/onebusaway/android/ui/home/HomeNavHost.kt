        ...
        composable(NavRoutes.HOME) { entry ->
            ...
            LaunchedEffect(revealStopId) {
                ...
                if (reveal != null) {
                    ...
                    // Only reachable on a corrupted / half-restored SavedStateHandle — the producer
                    // revealStopOnMap always writes all three keys atomically — so the focus is dropped.
                    // The keys are already consumed; record the latent path so it's findable.
