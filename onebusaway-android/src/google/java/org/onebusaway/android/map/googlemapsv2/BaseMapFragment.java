...
/**
 * Thin {@link Fragment} wrapper around {@link GoogleMapHost}. Home hosts the map directly via
 ...
 * working unchanged — it owns a {@link GoogleMapHost}, forwards the Fragment lifecycle to it, drives
 * the location-permission request through an {@link ActivityResultLauncher} (as {@link MapHostDeps}),
 * and delegates the {@link ObaMapFragment} contract to the host.
 *
 ...
 */
public class BaseMapFragment extends Fragment implements ObaMapFragment, MapHostDeps {
    ...
    public static final float DEFAULT_MAP_PADDING_DP = GoogleMapHost.DEFAULT_MAP_PADDING_DP;

    private GoogleMapHost mHost;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mHost = new GoogleMapHost(requireActivity(), this, args);
