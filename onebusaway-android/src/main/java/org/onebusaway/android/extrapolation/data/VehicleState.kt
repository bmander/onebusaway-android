...
data class VehicleState(
    ...
    companion object {
        ...
        @JvmStatic
        fun create(
            vehicleId: String?, activeTripId: String?, position: Location?,
            lastKnownLocation: Location?, distanceAlongTrip: Double?,
            scheduledDistanceAlongTrip: Double?, totalDistanceAlongTrip: Double?,
            lastUpdateTime: Long, lastLocationUpdateTime: Long,
            scheduleDeviation: Long, predicted: Boolean, timestamp: Long
        ) = VehicleState(
            vehicleId, activeTripId, position, lastKnownLocation,
         ...
         */
        @JvmStatic
        fun fromTripStatus(status: ObaTripStatus) = VehicleState(
