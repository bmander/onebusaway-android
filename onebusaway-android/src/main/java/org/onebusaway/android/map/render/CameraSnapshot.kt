...
/**
 * The live camera, published from the Compose layer (Google: `CameraPositionState`; maplibre: the
 * map's camera-idle listener) into `MapViewModel` so the reactive loaders can react to pan/zoom.
 *
