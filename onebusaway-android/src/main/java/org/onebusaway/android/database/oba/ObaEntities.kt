...
data class RegionRecord(
    ...
    @ColumnInfo(name = "travel_behavior_data_collection") val travelBehaviorDataCollection: Int? = null,
    @ColumnInfo(name = "enroll_participants_in_study") val enrollParticipantsInStudy: Int? = null,
