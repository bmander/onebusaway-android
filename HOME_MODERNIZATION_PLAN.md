...
> hamburger opens the drawer directly). Phases P13–P14 below are unchanged; **P13 (Compose the
> remaining dialogs + final sweep) is next.**
...
### P13 — Compose the remaining dialogs + final sweep
