...
public class SpeedEstimatorTest {
    ...
    @Test
    public void testGammaSpeedEstimator_returnsGammaMedian() {
        ...
        // Speed should equal the gamma median
        double expectedMedian = GammaSpeedModel.medianSpeedMps(params);
    ...
    public void testEndToEndSpeedEstimation() {
        ...
        // Cache a schedule so speed estimation has a prior
        ObaTripSchedule schedule = createSchedule(
                new double[]{0, 5000, 10000},
                new long[]{0, 500, 1000},
                new long[]{0, 500, 1000}
        );
        dm.putSchedule("trip1", schedule);
        // Service date well in the past so trip is considered started
