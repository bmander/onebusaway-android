...
class LegacyDataImporterTest {
    ...
    fun importsAllTablesAndPreservesUserData() = runBlocking {
        ...
        // region_bounds.region_id still points at the preserved regions._id.
        assertEquals(1, scalarInt("SELECT region_id FROM region_bounds LIMIT 1"))
        assertEquals(1, scalarInt("SELECT _id FROM regions LIMIT 1"))
        ...
        SQLiteDatabase.openOrCreateDatabase(file, null).use { db ->
            ...
            db.execSQL(
                "INSERT INTO regions (_id, name, oba_base_url, siri_base_url, lang, contact_email, " +
                    ...
                    "VALUES (1,'Puget Sound','http://oba','http://siri','en','e@x.com',1,1,0)"
            )
            db.execSQL(
